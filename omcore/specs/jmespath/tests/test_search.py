...
class TestSearchOptions(unittest.TestCase):
    ...
    def test_can_provide_custom_functions(self):
        ...
        self.assertEqual(jmespath.search('custom_add(`1`, `2`)', {}, options=options), 3)
        self.assertEqual(jmespath.search('my_subtract(`10`, `3`)', {}, options=options), 7)
        # Should still be able to use the original functions without any interference from the CustomFunctions class.

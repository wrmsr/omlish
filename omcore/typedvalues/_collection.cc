// @om-cext
// @om-llm-author "claude-sonnet-4-5-20250929"
...
#define _PACKAGE_NAME "omcore.typedvalues"
...
PyDoc_STRVAR(collection_doc, "Native C++ implementations for omcore.typedvalues.collection");
...
static int collection_exec(PyObject *module)
{
    ...
    // Import TypedValue
    PyObject *values_module = PyImport_ImportModule("omcore.typedvalues.values");
    ...
    PyObject *collection_module = PyImport_ImportModule("omcore.typedvalues.collection");

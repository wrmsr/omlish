...
`omcore.inject` provides constructor-based dependency injection with explicit, declarative configuration. Like Guice, it
...
While inspired by Guice, `omcore.inject` differs in several key ways:

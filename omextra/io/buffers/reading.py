...
def _coalesce_exact(buf: ta.Any, n: int) -> memoryview:
    """
...
def peek_u16_be(buf: ta.Any) -> int:
...
def read_u16_be(buf: ta.Any) -> int:
...
def peek_u16_le(buf: ta.Any) -> int:
...
def read_u16_le(buf: ta.Any) -> int:
...
def peek_u32_be(buf: ta.Any) -> int:
...
def read_u32_be(buf: ta.Any) -> int:
...
def peek_u32_le(buf: ta.Any) -> int:
...
def read_u32_le(buf: ta.Any) -> int:
...
def peek_exact(buf: ta.Any, n: int, /) -> memoryview:
    """
...
def take(buf: ta.Any, n: int, /) -> ta.Any:
    """
...
def read_bytes(buf: ta.Any, n: int, /) -> bytes:
    """

...
class HttpResponseConditionalGzipDecompressor(ChannelPipelineHandler):
    """
    Conditional streaming gzip decompression.

    Watches for HttpResponseHead; if Content-Encoding includes 'gzip', enable zlib decompressor for body bytes. Flushes
    on EOF.
    """
    ...
    def inbound(self, ctx: ChannelPipelineHandlerContext, msg: ta.Any) -> None:
        ...
        if isinstance(msg, HttpResponseHead):

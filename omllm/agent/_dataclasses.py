...
@_register(
    plan_repr=(
        ...
        ".Field(name='llm_options', kw_only=True, fn=None),), id=False, terse=False, default_fn=None)))"
    ),
    plan_repr_sha1='303b8383b9811dc3e6bfb0b535e623352cf37811',
    cls_names=(
        ('omllm.agent.loop', 'LoopConfig'),
    ),
)
def _process_dataclass__303b8383b9811dc3e6bfb0b535e623352cf37811():
    def _process_dataclass(
        *,
        __class__,
        ...
        def __repr__(self):
            parts = []
            parts.append(f"llm_options={self.llm_options!r}")
            return (

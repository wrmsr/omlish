...
@dc.dataclass(frozen=True)
@msh.update_field_options(['title', 'text'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['title', 'url'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['name', 'value'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['name', 'params'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['l', 'atts', 'body', 'r'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['title'], omit_if=operator.not_)
...
@dc.dataclass(frozen=True)
@msh.update_field_options(['name', 'default'], omit_if=operator.not_)

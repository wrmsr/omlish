...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'SimpleObjectMarshalerFactory'),
        ('ommlds.backends.groq._marshal', 'SimpleObjectUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'FieldOptions'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'PolymorphismUnionMarshalerFactory'),
        ('ommlds.backends.groq._marshal', 'PolymorphismUnionUnmarshalerFactory'),
        ('ommlds.backends.groq._marshal', '_BasePolymorphismUnionFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'ObjectMetadata'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'TypeMapMarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'FieldInfo'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'PrimitiveMarshalerUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'ObjectMarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'LiteralUnionMarshaler'),
        ('ommlds.backends.groq._marshal', 'LiteralUnionUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'PrimitiveUnionMarshalerFactory'),
        ('ommlds.backends.groq._marshal', 'PrimitiveUnionUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'FieldMetadata'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'TypeMapUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'FieldInfos'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'ObjectUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'PrimitiveUnionMarshaler'),
        ('ommlds.backends.groq._marshal', 'PrimitiveUnionUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.groq._marshal', 'ObjectSpecials'),
    ),
)

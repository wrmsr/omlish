...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'SimpleObjectMarshalerFactory'),
        ('ommlds.backends.openai.protocol._marshal', 'SimpleObjectUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'FieldOptions'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'PolymorphismUnionMarshalerFactory'),
        ('ommlds.backends.openai.protocol._marshal', 'PolymorphismUnionUnmarshalerFactory'),
        ('ommlds.backends.openai.protocol._marshal', '_BasePolymorphismUnionFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'ObjectMetadata'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'TypeMapMarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'FieldInfo'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'PrimitiveMarshalerUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'ObjectMarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'LiteralUnionMarshaler'),
        ('ommlds.backends.openai.protocol._marshal', 'LiteralUnionUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'PrimitiveUnionMarshalerFactory'),
        ('ommlds.backends.openai.protocol._marshal', 'PrimitiveUnionUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'FieldMetadata'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'TypeMapUnmarshalerFactory'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'FieldInfos'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'ObjectUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol._marshal', 'PrimitiveUnionMarshaler'),
        ('ommlds.backends.openai.protocol._marshal', 'PrimitiveUnionUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.backends.openai.protocol', 'ObjectSpecials'),
    ),
)

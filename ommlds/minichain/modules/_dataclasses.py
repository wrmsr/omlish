...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('name', 'config_cls')), EqPlan(fields=('name', 'config_cls')), FrozenPlan(fields=("
        "'name', 'config_cls'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('name', 'config_cls')"
        ...
        "alidate=None, check_type=None), InitPlan.Field(name='config_cls', annotation=OpRef(name='init.fields.1.annotat"
        "ion'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=No"
        "ne, validate=None, check_type=None)), self_param='self', std_params=(), kw_only_params=('name', 'config_cls'),"
        " frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Fie"
        "ld(name='name', kw_only=True, fn=None), ReprPlan.Field(name='config_cls', kw_only=True, fn=None)), id=False, t"
        "erse=False, default_fn=None)))"
    ),
    plan_repr_sha1='560e4085d0b4c3d91f077452d35c1afccffaddd9',
    op_ref_idents=(
...
def _process_dataclass__560e4085d0b4c3d91f077452d35c1afccffaddd9():
    def _process_dataclass(
        *,
        __dataclass__cls,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            return (
                ...
                self.config_cls == other.config_cls
            )
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.modules.inject', 'FsConfig'),
    ),
)

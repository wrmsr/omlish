...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.content.transform.materialize', 'PlaceholderContentMissingError'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.content.transform.prepare', 'DefaultContentPreparer'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.content.transform.prepare', 'DefaultContentStrPreparer'),
    ),
)

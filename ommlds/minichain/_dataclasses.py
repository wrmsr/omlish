...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.content._marshal', '_CanContentMarshaler'),
        ('ommlds.minichain.content._marshal', '_CanContentUnmarshaler'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.backends.impls.mistral', 'ContentPlaceholder'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.backends.impls.mistral', 'ContentPlaceholderMissingError'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.backends.impls.mistral', 'SimpleExtendedContent'),
        ('ommlds.minichain.backends.impls.mistral', 'SimpleSingleExtendedContent'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.backends.impls.openai.chat', 'JsonContent'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.minichain.content._marshal', 'TagContent'),
    ),
)

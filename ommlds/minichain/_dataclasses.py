...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('stream_outputs', 'event_processor', 'finalizer')), EqPlan(fields=('stream_outputs"
        "', 'event_processor', 'finalizer')), FrozenPlan(fields=('stream_outputs', 'event_processor', 'finalizer'), all"
        "ow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('stream_outputs', 'event_processor', 'finalizer"
        "'), cache=False), InitPlan(fields=(InitPlan.Field(name='stream_outputs', annotation=OpRef(name='init.fields.0."
        "annotation'), default=OpRef(name='init.fields.0.default'), default_factory=None, init=True, override=False, fi"
        "eld_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='event_processo"
        "r', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init.fields.1.default'), default_fa"
        "ctory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=N"
        "one), InitPlan.Field(name='finalizer', annotation=OpRef(name='init.fields.2.annotation'), default=OpRef(name='"
        "init.fields.2.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerc"
        "e=None, validate=None, check_type=None)), self_param='self', std_params=(), kw_only_params=('stream_outputs', "
        "'event_processor', 'finalizer'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()"
        "), ReprPlan(fields=(ReprPlan.Field(name='stream_outputs', kw_only=True, fn=None), ReprPlan.Field(name='event_p"
        "rocessor', kw_only=True, fn=None), ReprPlan.Field(name='finalizer', kw_only=True, fn=None)), id=False, terse=F"
        "alse, default_fn=None)))"
    ),
    plan_repr_sha1='67c5a22e3380b46913f327470361e2cad65a610d',
    op_ref_idents=(
        '__dataclass__init__fields__0__annotation',
        '__dataclass__init__fields__0__default',
        '__dataclass__init__fields__1__annotation',
    ...
    cls_names=(
        ('ommlds.minichain.http.stream', 'SseHttpStreamResponseHandling'),
    ),
)
def _process_dataclass__67c5a22e3380b46913f327470361e2cad65a610d():
    def _process_dataclass(
        *,
        __dataclass__cls,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.stream_outputs == other.stream_outputs and
                self.event_processor == other.event_processor and
        ...
        def __init__(
            self,
            *,
            stream_outputs: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
            event_processor: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
            finalizer: __dataclass__init__fields__2__annotation = __dataclass__init__fields__2__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'stream_outputs', stream_outputs)
            __dataclass__object_setattr(self, 'event_processor', event_processor)
            __dataclass__object_setattr(self, 'finalizer', finalizer)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"stream_outputs={self.stream_outputs!r}")
            parts.append(f"event_processor={self.event_processor!r}")
            parts.append(f"finalizer={self.finalizer!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"

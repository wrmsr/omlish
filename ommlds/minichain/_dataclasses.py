...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.backends.scripted.chat', 'ScriptedChatCursor'),
        ('ommlds.minichain.backends.scripted.chat', 'ScriptedChatScript'),
        ...
        ('ommlds.minichain.content.metadata', 'ContentUuid'),
        ...
        ('ommlds.minichain.llms.types', 'TopK'),
        ('ommlds.minichain.metadata', 'CreatedAt'),
        ('ommlds.minichain.metadata', 'ParentRequestUuid'),
        ('ommlds.minichain.metadata', 'RequestUuid'),
        ('ommlds.minichain.metadata', 'ResponseUuid'),
        ('ommlds.minichain.models.attributes', 'ContextWindow'),
        ('ommlds.minichain.models.attributes', 'InputTokenCost'),
        ('ommlds.minichain.models.attributes', 'MaxOutputTokens'),
        ('ommlds.minichain.models.attributes', 'OutputTokenCost'),
        ('ommlds.minichain.models.attributes', 'SupportsReasoning'),
        ('ommlds.minichain.models.attributes', 'SupportsStructuredOutput'),
        ('ommlds.minichain.models.attributes', 'SupportsTools'),
        ('ommlds.minichain.models.configs', 'ModelName'),
        ('ommlds.minichain.models.configs', 'ModelPath'),
        ('ommlds.minichain.registries.reflect', 'RegistryTypeName'),
        ('ommlds.minichain.resources', 'UseResources'),
        ('ommlds.minichain.standard', 'ApiUrl'),
        ('ommlds.minichain.standard', 'Device'),
        ('ommlds.minichain.tokens.types', 'TokenStr'),
        ('ommlds.minichain.tools.metadata', 'ToolUseUuid'),
    ),
)
...
@_register(
    plan_repr=(
        ...
        "None)), self_param='self', std_params=('invocation_index', 'emission_index'), kw_only_params=(), frozen=True, "
        "slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='invoc"
        "ation_index', kw_only=False, fn=None), ReprPlan.Field(name='emission_index', kw_only=False, fn=None)), id=Fals"
...
def _process_dataclass__ccaebf4fb7679406f40a806736666baa87a8da54():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('emissions', 'outputs', 'expect')), EqPlan(fields=('emissions', 'outputs', 'expect"
        "')), FrozenPlan(fields=('emissions', 'outputs', 'expect'), allow_dynamic_dunder_attrs=False), HashPlan(action="
        "'add', fields=('emissions', 'outputs', 'expect'), cache=False), InitPlan(fields=(InitPlan.Field(name='emission"
        "s', annotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=True, override"
        "=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='outp"
        "uts', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init.fields.1.default'), default_"
        "factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type"
        "=None), InitPlan.Field(name='expect', annotation=OpRef(name='init.fields.2.annotation'), default=OpRef(name='i"
        "nit.fields.2.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce"
        "=None, validate=None, check_type=None)), self_param='self', std_params=('emissions',), kw_only_params=('output"
        "s', 'expect'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields"
        "=(ReprPlan.Field(name='emissions', kw_only=False, fn=None), ReprPlan.Field(name='outputs', kw_only=True, fn=No"
...
def _process_dataclass__e0ff7c202a797a3e06b7033215fcd322272d42ec():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.emissions == other.emissions and
        ...
        def __init__(
            self,
            emissions: __dataclass__init__fields__0__annotation,
            *,
            outputs: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
            expect: __dataclass__init__fields__2__annotation = __dataclass__init__fields__2__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'emissions', emissions)
            __dataclass__object_setattr(self, 'outputs', outputs)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"emissions={self.emissions!r}")
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('gs', '_outputs')), EqPlan(fields=('gs', '_outputs')), FrozenPlan(fields=('gs', '_"
        "outputs'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('gs', '_outputs'), cache=False), "
        "InitPlan(fields=(InitPlan.Field(name='gs', annotation=OpRef(name='init.fields.0.annotation'), default=None, de"
        "fault_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, chec"
        "k_type=None), InitPlan.Field(name='_outputs', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef"
        ...
        "'gs', '_outputs'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_f"
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='gs', kw_only=False, fn=None), ReprPlan.Field(name='_outputs', kw"
...
def _process_dataclass__359ea63ec43ebbd80eea38a7c7254083378ba7d9():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            gs: __dataclass__init__fields__0__annotation,
            ...
            __dataclass__object_setattr(self, 'gs', gs)
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.llms.stopreasons', 'EndTurnStopReason'),
        ('ommlds.minichain.llms.stopreasons', 'MaxTokensStopReason'),
        ('ommlds.minichain.llms.stopreasons', 'StopSequenceStopReason'),
        ('ommlds.minichain.llms.stopreasons', 'ToolUseStopReason'),
        ('ommlds.minichain.metadata', 'MetadataContainerDataclass'),
        ('ommlds.minichain.specs.types', 'BackendSpec'),
        ('ommlds.minichain.tools.fns', 'ToolFn.Impl'),
        ('ommlds.minichain.tools.fns', 'ToolFn.Input'),
        ('ommlds.minichain.tools.fns', 'ToolFn.Output'),
        ('ommlds.minichain.tools.fns', 'ToolFn.RawKwargsInput'),
        ('ommlds.minichain.tools.fns', 'ToolFn.RawStringOutput'),
        ('ommlds.minichain.tools.permissions.bash', 'BashToolPermissionMatcher'),
        ('ommlds.minichain.tools.permissions.types', 'ToolPermissionTarget'),
        ('ommlds.minichain.tools.types', 'ToolDtype'),
    ),
)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('chat', '_outputs', '_metadata')), EqPlan(fields=('chat', '_outputs', '_metadata')"
        "), FrozenPlan(fields=('chat', '_outputs', '_metadata'), allow_dynamic_dunder_attrs=False), HashPlan(action='ad"
        "d', fields=('chat', '_outputs', '_metadata'), cache=False), InitPlan(fields=(InitPlan.Field(name='chat', annot"
        "ation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=True, override=False, f"
        "ield_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='_outputs', an"
        "notation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init.fields.1.default'), default_factory="
        "None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=OpRef(name='init.fields.1.coerce'), val"
        "idate=None, check_type=None), InitPlan.Field(name='_metadata', annotation=OpRef(name='init.fields.2.annotation"
        "'), default=OpRef(name='init.fields.2.default'), default_factory=None, init=True, override=False, field_type=F"
        "ieldType.INSTANCE, coerce=OpRef(name='init.fields.2.coerce'), validate=None, check_type=None)), self_param='se"
        "lf', std_params=('chat', '_outputs'), kw_only_params=('_metadata',), frozen=True, slots=False, post_init_param"
        "s=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='chat', kw_only=False, fn=None), R"
        "eprPlan.Field(name='_outputs', kw_only=False, fn=OpRef(name='repr.fns.1.fn'))), id=False, terse=True, default_"
        "fn=None)))"
    ),
...
def _process_dataclass__589164ce9e102f5217e593a1fceb02c9197899df():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.chat.messages', 'Message'),
        ('ommlds.minichain.chat.stream.types', 'AiDelta'),
        ('ommlds.minichain.content.blank', 'BlankContent'),
        ('ommlds.minichain.content.composite', 'CompositeContent'),
        ('ommlds.minichain.content.dynamic', 'DynamicContent'),
        ('ommlds.minichain.content.recursive', 'RecursiveContent'),
        ('ommlds.minichain.content.standard', 'StandardContent'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.chat.messages', 'ThinkingMessage'),
        ('ommlds.minichain.chat.stream.types', 'ContentAiDelta'),
        ('ommlds.minichain.chat.stream.types', 'ThinkingAiDelta'),
    ),
)
...
def _process_dataclass__200e0f3ce4ae55a4f99dd8e89742cc669eb698ca():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
...
def _process_dataclass__7b47404e82599d01ee0c86a2774370bbdd2c6d8e():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('cs', '_outputs')), EqPlan(fields=('cs', '_outputs')), FrozenPlan(fields=('cs', '_"
        "outputs'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('cs', '_outputs'), cache=False), "
        "InitPlan(fields=(InitPlan.Field(name='cs', annotation=OpRef(name='init.fields.0.annotation'), default=None, de"
        "fault_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, chec"
        "k_type=None), InitPlan.Field(name='_outputs', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef"
        "(name='init.fields.1.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE"
        ", coerce=OpRef(name='init.fields.1.coerce'), validate=None, check_type=None)), self_param='self', std_params=("
        "'cs', '_outputs'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_f"
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='cs', kw_only=False, fn=None), ReprPlan.Field(name='_outputs', kw"
        "_only=False, fn=OpRef(name='repr.fns.1.fn'))), id=False, terse=True, default_fn=None)))"
    ),
...
def _process_dataclass__7c6a0d37f87ddad2b2a0d33a1e05078ba71b2b72():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            cs: __dataclass__init__fields__0__annotation,
            _outputs: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
        ) -> __dataclass__None:
            _outputs = __dataclass__init__fields__1__coerce(_outputs)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('_metadata', 'id', 'name')), EqPlan(fields=('_metadata', 'id', 'name')), FrozenPla"
        "n(fields=('_metadata', 'id', 'name'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('_meta"
        "data', 'id', 'name'), cache=False), InitPlan(fields=(InitPlan.Field(name='_metadata', annotation=OpRef(name='i"
        ...
        "=None), InitPlan.Field(name='id', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init."
        "fields.1.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=Non"
        "e, validate=None, check_type=None), InitPlan.Field(name='name', annotation=OpRef(name='init.fields.2.annotatio"
        ...
        "arams=('_metadata', 'id', 'name'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns="
        "()), ReprPlan(fields=(ReprPlan.Field(name='id', kw_only=True, fn=None), ReprPlan.Field(name='name', kw_only=Tr"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('g', '_outputs')), EqPlan(fields=('g', '_outputs')), FrozenPlan(fields=('g', '_out"
        "puts'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('g', '_outputs'), cache=False), Init"
        "Plan(fields=(InitPlan.Field(name='g', annotation=OpRef(name='init.fields.0.annotation'), default=None, default"
        "_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_typ"
        "e=None), InitPlan.Field(name='_outputs', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name"
        "='init.fields.1.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coe"
        "rce=OpRef(name='init.fields.1.coerce'), validate=None, check_type=None)), self_param='self', std_params=('g', "
        "'_outputs'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=())"
        ", ReprPlan(fields=(ReprPlan.Field(name='g', kw_only=False, fn=None), ReprPlan.Field(name='_outputs', kw_only=F"
...
def _process_dataclass__149c9876e79dbcbee467252055e6c8ac40881616():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            g: __dataclass__init__fields__0__annotation,
            _outputs: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
        ) -> __dataclass__None:
            _outputs = __dataclass__init__fields__1__coerce(_outputs)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('_metadata', 'id', 'name', 'raw_args', 'index')), EqPlan(fields=('_metadata', 'id'"
        ", 'name', 'raw_args', 'index')), FrozenPlan(fields=('_metadata', 'id', 'name', 'raw_args', 'index'), allow_dyn"
        "amic_dunder_attrs=False), HashPlan(action='add', fields=('_metadata', 'id', 'name', 'raw_args', 'index'), cach"
        "e=False), InitPlan(fields=(InitPlan.Field(name='_metadata', annotation=OpRef(name='init.fields.0.annotation'),"
        " default=OpRef(name='init.fields.0.default'), default_factory=None, init=True, override=False, field_type=Fiel"
        "dType.INSTANCE, coerce=OpRef(name='init.fields.0.coerce'), validate=None, check_type=None), InitPlan.Field(nam"
        "e='id', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init.fields.1.default'), defaul"
        "t_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_ty"
        "pe=None), InitPlan.Field(name='name', annotation=OpRef(name='init.fields.2.annotation'), default=OpRef(name='i"
        "nit.fields.2.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce"
        "=None, validate=None, check_type=None), InitPlan.Field(name='raw_args', annotation=OpRef(name='init.fields.3.a"
        "nnotation'), default=OpRef(name='init.fields.3.default'), default_factory=None, init=True, override=False, fie"
        "ld_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='index', annotat"
        ...
        "_param='self', std_params=(), kw_only_params=('_metadata', 'id', 'name', 'raw_args', 'index'), frozen=True, sl"
        "ots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='id', kw"
        "_only=True, fn=None), ReprPlan.Field(name='name', kw_only=True, fn=None), ReprPlan.Field(name='raw_args', kw_o"
        "nly=True, fn=None), ReprPlan.Field(name='index', kw_only=True, fn=None)), id=False, terse=False, default_fn=No"
        "ne)))"
    ),
...
def _process_dataclass__cf7e4e754e443a7176b73c36aca492948999ce4b():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            return (
                ...
                self.id == other.id and
                self.name == other.name and
                self.raw_args == other.raw_args and
        ...
        def __init__(
            ...
            *,
            ...
            index: __dataclass__init__fields__4__annotation = __dataclass__init__fields__4__default,
        ) -> __dataclass__None:
            _metadata = __dataclass__init__fields__0__coerce(_metadata)
            __dataclass__object_setattr(self, '_metadata', _metadata)
            __dataclass__object_setattr(self, 'id', id)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('_metadata', 'id', 'name', 'args')), EqPlan(fields=('_metadata', 'id', 'name', 'ar"
        "gs')), FrozenPlan(fields=('_metadata', 'id', 'name', 'args'), allow_dynamic_dunder_attrs=False), HashPlan(acti"
        "on='add', fields=('_metadata', 'id', 'name', 'args'), cache=False), InitPlan(fields=(InitPlan.Field(name='_met"
        "adata', annotation=OpRef(name='init.fields.0.annotation'), default=OpRef(name='init.fields.0.default'), defaul"
        "t_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=OpRef(name='init.fields.0.coe"
        "rce'), validate=None, check_type=None), InitPlan.Field(name='id', annotation=OpRef(name='init.fields.1.annotat"
        "ion'), default=OpRef(name='init.fields.1.default'), default_factory=None, init=True, override=False, field_typ"
        "e=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='name', annotation=OpR"
        ...
        "ld(name='args', annotation=OpRef(name='init.fields.3.annotation'), default=OpRef(name='init.fields.3.default')"
        ", default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, "
        "check_type=None)), self_param='self', std_params=(), kw_only_params=('_metadata', 'id', 'name', 'args'), froze"
        "n=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(nam"
        "e='id', kw_only=True, fn=None), ReprPlan.Field(name='name', kw_only=True, fn=None), ReprPlan.Field(name='args'"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('ct',)), EqPlan(fields=('ct',)), FrozenPlan(fields=('ct',), allow_dynamic_dunder_a"
        "ttrs=False), HashPlan(action='add', fields=('ct',), cache=False), InitPlan(fields=(InitPlan.Field(name='ct', a"
        ...
        "s=('ct',), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), "
        "ReprPlan(fields=(ReprPlan.Field(name='ct', kw_only=False, fn=None),), id=False, terse=False, default_fn=None))"
        ")"
    ),
...
@_register(
    plan_repr=(
        ...
        "zen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(n"
        "ame='s', kw_only=False, fn=None), ReprPlan.Field(name='lang', kw_only=True, fn=None)), id=False, terse=True, d"
        "efault_fn=None)))"
    ),
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='l', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
    ...
    cls_names=(
        ...
        ('ommlds.minichain.content.containers', 'FlowContent'),
    ),
)
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='s', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
    ...
    cls_names=(
        ...
        ('ommlds.minichain.content.emphasis', 'ItalicContent'),
        ('ommlds.minichain.content.markdown', 'MarkdownContent'),
        ('ommlds.minichain.content.text', 'TextContent'),
    ),
)
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='i', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='v', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
...
@_register(
    plan_repr=(
        ...
        "oerce=None, validate=None, check_type=None)), self_param='self', std_params=('url',), kw_only_params=('_metada"
        "ta', 'title'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields"
        "=(ReprPlan.Field(name='url', kw_only=False, fn=None), ReprPlan.Field(name='title', kw_only=True, fn=None)), id"
...
@_register(
    plan_repr=(
        ...
        "date_fns=()), ReprPlan(fields=(ReprPlan.Field(name='ns', kw_only=False, fn=None),), id=False, terse=True, defa"
        "ult_fn=None)))"
    ),
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='k', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('block_sep',)), EqPlan(fields=('block_sep',)), FrozenPlan(fields=('block_sep',), a"
        "llow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('block_sep',), cache=False), InitPlan(fields="
        "(InitPlan.Field(name='block_sep', annotation=OpRef(name='init.fields.0.annotation'), default=OpRef(name='init."
        "fields.0.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=Non"
        "e, validate=None, check_type=None),), self_param='self', std_params=(), kw_only_params=('block_sep',), frozen="
        ...
        *,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.block_sep == other.block_sep
            )
        ...
        def __init__(
            self,
            *,
            block_sep: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'block_sep', block_sep)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"block_sep={self.block_sep!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('placeholder_contents', 'templater_context')), EqPlan(fields=('placeholder_content"
        "s', 'templater_context')), FrozenPlan(fields=('placeholder_contents', 'templater_context'), allow_dynamic_dund"
        "er_attrs=False), HashPlan(action='add', fields=('placeholder_contents', 'templater_context'), cache=False), In"
        "itPlan(fields=(InitPlan.Field(name='placeholder_contents', annotation=OpRef(name='init.fields.0.annotation'), "
        "default=OpRef(name='init.fields.0.default'), default_factory=None, init=True, override=False, field_type=Field"
        "Type.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='templater_context', annotati"
        ...
        "param='self', std_params=(), kw_only_params=('placeholder_contents', 'templater_context'), frozen=True, slots="
        "False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='placeholder"
        "_contents', kw_only=True, fn=None), ReprPlan.Field(name='templater_context', kw_only=True, fn=None)), id=False"
        ...
        *,
        ...
        def __copy__(self):
            if self.__class__ is not __class__:
                raise TypeError(self)
            return __class__(  # noqa
                placeholder_contents=self.placeholder_contents,
                templater_context=self.templater_context,
            )
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.placeholder_contents == other.placeholder_contents and
                self.templater_context == other.templater_context
            )
        ...
        def __init__(
            self,
            *,
            placeholder_contents: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
            templater_context: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'placeholder_contents', placeholder_contents)
            __dataclass__object_setattr(self, 'templater_context', templater_context)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"placeholder_contents={self.placeholder_contents!r}")
            parts.append(f"templater_context={self.templater_context!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        ...
        "me='body', kw_only=False, fn=None), ReprPlan.Field(name='header', kw_only=True, fn=None)), id=False, terse=Tru"
        "e, default_fn=None)))"
    ),
...
@_register(
    plan_repr=(
        ...
        "False, fn=None), ReprPlan.Field(name='body', kw_only=False, fn=None)), id=False, terse=True, default_fn=None))"
        ")"
    ),
...
@_register(
    plan_repr=(
        ...
        "ns=()), ReprPlan(fields=(ReprPlan.Field(name='t', kw_only=False, fn=None),), id=False, terse=True, default_fn="
        "None)))"
    ),
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.transform.general', 'FnGeneralTransform'),
        ('ommlds.minichain.transform.sequence', 'FnSequenceTransform'),
    ),
)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('ty', 'ct')), EqPlan(fields=('ty', 'ct')), FrozenPlan(fields=('ty', 'ct'), allow_d"
        "ynamic_dunder_attrs=False), HashPlan(action='add', fields=('ty', 'ct'), cache=False), InitPlan(fields=(InitPla"
        ...
        "ield(name='ct', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, init=Tr"
        "ue, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None)), self_param='"
        "self', std_params=('ty', 'ct'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=("
    ...
    def _process_dataclass(
        *,
        ...
        def __init__(
            ...
            ct: __dataclass__init__fields__1__annotation,
        ) -> __dataclass__None:
...
def _process_dataclass__6c09a6beb5d85cdd42b177414c303bc876b420da():
    def _process_dataclass(
        *,
        ...
        setattr(__class__, 'children', __dataclass__property__children())
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('uuid', 'service')), EqPlan(fields=('uuid', 'service')), FrozenPlan(fields=('uuid'"
        ", 'service'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('uuid', 'service'), cache=Fals"
        ...
        "pe.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='service', annotation=OpRef(nam"
        ...
        "=('uuid', 'service'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan"
    ...
    cls_names=(
        ...
        ('ommlds.minichain.external', 'ExternalServiceStreamResponseStartEvent'),
    ),
)
def _process_dataclass__454ae5fa966a916f18d1276825559c78ac5b55f9():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            uuid: __dataclass__init__fields__0__annotation = __dataclass__HAS_DEFAULT_FACTORY,
            service: __dataclass__init__fields__1__annotation,
        ) -> __dataclass__None:
            if uuid is __dataclass__HAS_DEFAULT_FACTORY:
                uuid = __dataclass__init__fields__0__default_factory()
            __dataclass__object_setattr(self, 'uuid', uuid)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('uuid', 'service', 'request')), EqPlan(fields=('uuid', 'service', 'request')), Fro"
        "zenPlan(fields=('uuid', 'service', 'request'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', field"
        "s=('uuid', 'service', 'request'), cache=False), InitPlan(fields=(InitPlan.Field(name='uuid', annotation=OpRef("
        "name='init.fields.0.annotation'), default=None, default_factory=OpRef(name='init.fields.0.default_factory'), i"
        "nit=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPla"
        "n.Field(name='service', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None,"
        " init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitP"
        "lan.Field(name='request', annotation=OpRef(name='init.fields.2.annotation'), default=None, default_factory=Non"
        "e, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None)), se"
        "lf_param='self', std_params=(), kw_only_params=('uuid', 'service', 'request'), frozen=True, slots=False, post_"
        "init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='service', kw_only=True,"
...
def _process_dataclass__5a5e8fce7229c1deb5abb384cf4f4c7b24b1dcbe():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            uuid: __dataclass__init__fields__0__annotation = __dataclass__HAS_DEFAULT_FACTORY,
            service: __dataclass__init__fields__1__annotation,
            request: __dataclass__init__fields__2__annotation,
        ) -> __dataclass__None:
            if uuid is __dataclass__HAS_DEFAULT_FACTORY:
                uuid = __dataclass__init__fields__0__default_factory()
            __dataclass__object_setattr(self, 'uuid', uuid)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('uuid', 'service', 'response')), EqPlan(fields=('uuid', 'service', 'response')), F"
        "rozenPlan(fields=('uuid', 'service', 'response'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fi"
        "elds=('uuid', 'service', 'response'), cache=False), InitPlan(fields=(InitPlan.Field(name='uuid', annotation=Op"
        ...
        "tPlan.Field(name='service', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=N"
        "one, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), I"
        "nitPlan.Field(name='response', annotation=OpRef(name='init.fields.2.annotation'), default=None, default_factor"
        "y=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None)"
        "), self_param='self', std_params=(), kw_only_params=('uuid', 'service', 'response'), frozen=True, slots=False,"
        " post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='service', kw_only"
        "=True, fn=None), ReprPlan.Field(name='response', kw_only=True, fn=None)), id=False, terse=False, default_fn=No"
        "ne)))"
    ),
...
def _process_dataclass__6b62ce8cff8a2a6e74fbd39e15c643e21f40719a():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            uuid: __dataclass__init__fields__0__annotation = __dataclass__HAS_DEFAULT_FACTORY,
            service: __dataclass__init__fields__1__annotation,
            response: __dataclass__init__fields__2__annotation,
        ) -> __dataclass__None:
            if uuid is __dataclass__HAS_DEFAULT_FACTORY:
                uuid = __dataclass__init__fields__0__default_factory()
            __dataclass__object_setattr(self, 'uuid', uuid)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('uuid', 'service', 'data')), EqPlan(fields=('uuid', 'service', 'data')), FrozenPla"
        "n(fields=('uuid', 'service', 'data'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('uuid'"
        ", 'service', 'data'), cache=False), InitPlan(fields=(InitPlan.Field(name='uuid', annotation=OpRef(name='init.f"
        "ields.0.annotation'), default=None, default_factory=OpRef(name='init.fields.0.default_factory'), init=True, ov"
        "erride=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name"
        "='service', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, init=True, "
        "override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(na"
        "me='data', annotation=OpRef(name='init.fields.2.annotation'), default=None, default_factory=None, init=True, o"
        "verride=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None)), self_param='self'"
        ", std_params=(), kw_only_params=('uuid', 'service', 'data'), frozen=True, slots=False, post_init_params=None, "
        "init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='service', kw_only=True, fn=None), ReprPla"
...
def _process_dataclass__f4d3c565ba375551c23eb3774a834b33a9132e4d():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            uuid: __dataclass__init__fields__0__annotation = __dataclass__HAS_DEFAULT_FACTORY,
            service: __dataclass__init__fields__1__annotation,
            data: __dataclass__init__fields__2__annotation,
        ) -> __dataclass__None:
            if uuid is __dataclass__HAS_DEFAULT_FACTORY:
                uuid = __dataclass__init__fields__0__default_factory()
            __dataclass__object_setattr(self, 'uuid', uuid)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('raw',)), EqPlan(fields=('raw',)), FrozenPlan(fields=('raw',), allow_dynamic_dunde"
        "r_attrs=False), HashPlan(action='add', fields=('raw',), cache=False), InitPlan(fields=(InitPlan.Field(name='ra"
        "w', annotation=OpRef(name='init.fields.0.annotation'), default=OpRef(name='init.fields.0.default'), default_fa"
        "ctory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=N"
        "one),), self_param='self', std_params=('raw',), kw_only_params=(), frozen=True, slots=False, post_init_params="
        "None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='raw', kw_only=False, fn=None),), id"
...
def _process_dataclass__2c23ad8164379a22ea8f01a7ffc1e511cb99039b():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            raw: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
        ) -> __dataclass__None:
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('request_v', 'request_option', 'response_v', 'response_output')), EqPlan(fields=('"
        "request_v', 'request_option', 'response_v', 'response_output')), FrozenPlan(fields=('request_v', 'request_opti"
        "on', 'response_v', 'response_output'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('requ"
        "est_v', 'request_option', 'response_v', 'response_output'), cache=False), InitPlan(fields=(InitPlan.Field(name"
        "='request_v', annotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=True"
        ", override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field("
        "name='request_option', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, "
        "init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPl"
        "an.Field(name='response_v', annotation=OpRef(name='init.fields.2.annotation'), default=None, default_factory=N"
        "one, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), I"
        "nitPlan.Field(name='response_output', annotation=OpRef(name='init.fields.3.annotation'), default=None, default"
        "_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_typ"
        "e=None)), self_param='self', std_params=(), kw_only_params=('request_v', 'request_option', 'response_v', 'resp"
        "onse_output'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields"
        "=(ReprPlan.Field(name='request_v', kw_only=True, fn=None), ReprPlan.Field(name='request_option', kw_only=True,"
        " fn=None), ReprPlan.Field(name='response_v', kw_only=True, fn=None), ReprPlan.Field(name='response_output', kw"
...
def _process_dataclass__3f5b24684e34edfb61c5b5d7560fb33e6995fc3b():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __copy__(self):
            if self.__class__ is not __class__:
                raise TypeError(self)
            return __class__(  # noqa
                request_v=self.request_v,
                request_option=self.request_option,
                response_v=self.response_v,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.request_v == other.request_v and
                self.request_option == other.request_option and
                self.response_v == other.response_v and
                self.response_output == other.response_output
            )
        ...
        def __init__(
            self,
            *,
            request_v: __dataclass__init__fields__0__annotation,
            request_option: __dataclass__init__fields__1__annotation,
            response_v: __dataclass__init__fields__2__annotation,
            response_output: __dataclass__init__fields__3__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'request_v', request_v)
            __dataclass__object_setattr(self, 'request_option', request_option)
            __dataclass__object_setattr(self, 'response_v', response_v)
            __dataclass__object_setattr(self, 'response_output', response_output)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"request_v={self.request_v!r}")
            parts.append(f"request_option={self.request_option!r}")
            parts.append(f"response_v={self.response_v!r}")
            parts.append(f"response_output={self.response_output!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('request_v', 'request_option', 'response_v', 'response_output', 'stream_response_v"
        "', 'stream_response_output')), EqPlan(fields=('request_v', 'request_option', 'response_v', 'response_output', "
        "'stream_response_v', 'stream_response_output')), FrozenPlan(fields=('request_v', 'request_option', 'response_v"
        "', 'response_output', 'stream_response_v', 'stream_response_output'), allow_dynamic_dunder_attrs=False), HashP"
        "lan(action='add', fields=('request_v', 'request_option', 'response_v', 'response_output', 'stream_response_v',"
        " 'stream_response_output'), cache=False), InitPlan(fields=(InitPlan.Field(name='request_v', annotation=OpRef(n"
        "ame='init.fields.0.annotation'), default=None, default_factory=None, init=True, override=False, field_type=Fie"
        "ldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='request_option', annotatio"
        "n=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, init=True, override=False, field"
        "_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='response_v', anno"
        "tation=OpRef(name='init.fields.2.annotation'), default=None, default_factory=None, init=True, override=False, "
        "field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='response_out"
        "put', annotation=OpRef(name='init.fields.3.annotation'), default=None, default_factory=None, init=True, overri"
        "de=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='st"
        "ream_response_v', annotation=OpRef(name='init.fields.4.annotation'), default=None, default_factory=None, init="
        "True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Fi"
        "eld(name='stream_response_output', annotation=OpRef(name='init.fields.5.annotation'), default=None, default_fa"
        "ctory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=N"
        "one)), self_param='self', std_params=(), kw_only_params=('request_v', 'request_option', 'response_v', 'respons"
        "e_output', 'stream_response_v', 'stream_response_output'), frozen=True, slots=False, post_init_params=None, in"
        "it_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='request_v', kw_only=True, fn=None), ReprPla"
        "n.Field(name='request_option', kw_only=True, fn=None), ReprPlan.Field(name='response_v', kw_only=True, fn=None"
        "), ReprPlan.Field(name='response_output', kw_only=True, fn=None), ReprPlan.Field(name='stream_response_v', kw_"
        "only=True, fn=None), ReprPlan.Field(name='stream_response_output', kw_only=True, fn=None)), id=False, terse=Fa"
        "lse, default_fn=None)))"
    ),
...
def _process_dataclass__3d264be1f5ee88859fccebd877579e2fd0e6b0a7():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __copy__(self):
            ...
            return __class__(  # noqa
                ...
                response_v=self.response_v,
                response_output=self.response_output,
                stream_response_v=self.stream_response_v,
                stream_response_output=self.stream_response_output,
            )
        ...
        def __eq__(self, other):
            ...
            return (
                ...
                self.request_option == other.request_option and
                self.response_v == other.response_v and
                self.response_output == other.response_output and
                self.stream_response_v == other.stream_response_v and
                self.stream_response_output == other.stream_response_output
            )
        ...
        def __hash__(self):
            return hash((
                ...
                self.response_v,
                self.response_output,
                self.stream_response_v,
                self.stream_response_output,
            ))
        ...
        def __init__(
            ...
            *,
            ...
            response_v: __dataclass__init__fields__2__annotation,
            response_output: __dataclass__init__fields__3__annotation,
            stream_response_v: __dataclass__init__fields__4__annotation,
            stream_response_output: __dataclass__init__fields__5__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'request_v', request_v)
            __dataclass__object_setattr(self, 'request_option', request_option)
            __dataclass__object_setattr(self, 'response_v', response_v)
            __dataclass__object_setattr(self, 'response_output', response_output)
            __dataclass__object_setattr(self, 'stream_response_v', stream_response_v)
            __dataclass__object_setattr(self, 'stream_response_output', stream_response_output)
        ...
        def __repr__(self):
            ...
            parts.append(f"response_v={self.response_v!r}")
            parts.append(f"response_output={self.response_output!r}")
            parts.append(f"stream_response_v={self.stream_response_v!r}")
            parts.append(f"stream_response_output={self.stream_response_output!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('service_cls', 'rec', 'registry', 'registry_type')), EqPlan(fields=('service_cls',"
        " 'rec', 'registry', 'registry_type')), FrozenPlan(fields=('service_cls', 'rec', 'registry', 'registry_type'), "
        "allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('service_cls', 'rec', 'registry', 'registry_"
        "type'), cache=False), InitPlan(fields=(InitPlan.Field(name='service_cls', annotation=OpRef(name='init.fields.0"
        ".annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, c"
        "oerce=None, validate=None, check_type=None), InitPlan.Field(name='rec', annotation=OpRef(name='init.fields.1.a"
        "nnotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coe"
        "rce=None, validate=None, check_type=None), InitPlan.Field(name='registry', annotation=OpRef(name='init.fields."
        "2.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, "
        "coerce=None, validate=None, check_type=None), InitPlan.Field(name='registry_type', annotation=OpRef(name='init"
        ".fields.3.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.IN"
        "STANCE, coerce=None, validate=None, check_type=None)), self_param='self', std_params=(), kw_only_params=('serv"
        "ice_cls', 'rec', 'registry', 'registry_type'), frozen=True, slots=False, post_init_params=None, init_fns=(), v"
        "alidate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='service_cls', kw_only=True, fn=None), ReprPlan.Field(na"
        "me='rec', kw_only=True, fn=None), ReprPlan.Field(name='registry', kw_only=True, fn=None), ReprPlan.Field(name="
...
def _process_dataclass__c88e2257b7e0488f2a75dc611d7f8223aacbe77f():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            return (
                ...
                self.registry_type == other.registry_type
            )
        ...
        def __init__(
            ...
            *,
            ...
            rec: __dataclass__init__fields__1__annotation,
            registry: __dataclass__init__fields__2__annotation,
            registry_type: __dataclass__init__fields__3__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'service_cls', service_cls)
            __dataclass__object_setattr(self, 'rec', rec)
            __dataclass__object_setattr(self, 'registry', registry)
            __dataclass__object_setattr(self, 'registry_type', registry_type)
        ...
        def __repr__(self):
            ...
            parts.append(f"rec={self.rec!r}")
            parts.append(f"registry={self.registry!r}")
            parts.append(f"registry_type={self.registry_type!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('child', 'configs')), EqPlan(fields=('child', 'configs')), FrozenPlan(fields=('chi"
        "ld', 'configs'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('child', 'configs'), cache="
        "False), InitPlan(fields=(InitPlan.Field(name='child', annotation=OpRef(name='init.fields.0.annotation'), defau"
        "lt=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate"
        "=None, check_type=None), InitPlan.Field(name='configs', annotation=OpRef(name='init.fields.1.annotation'), def"
        "ault=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, valida"
        "te=None, check_type=None)), self_param='self', std_params=('child', 'configs'), kw_only_params=(), frozen=True"
        ", slots=False, post_init_params=(), init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='child"
        "', kw_only=False, fn=None), ReprPlan.Field(name='configs', kw_only=False, fn=None)), id=False, terse=False, de"
        "fault_fn=None)))"
    ),
    ...
    def _process_dataclass(
        *,
        ...
        def __init__(
            self,
            child: __dataclass__init__fields__0__annotation,
            configs: __dataclass__init__fields__1__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'child', child)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"child={self.child!r}")
            parts.append(f"configs={self.configs!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('children',)), EqPlan(fields=('children',)), FrozenPlan(fields=('children',), allo"
        "w_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('children',), cache=False), InitPlan(fields=(Ini"
        "tPlan.Field(name='children', annotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory="
        "None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None),)"
        ", self_param='self', std_params=('children',), kw_only_params=(), frozen=True, slots=False, post_init_params=N"
        "one, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='children', kw_only=False, fn=None),)"
        ", id=False, terse=False, default_fn=None)))"
    ),
...
def _process_dataclass__8390811a304c1b08264c919ffc6824d6ea4a3a2c():
    def _process_dataclass(
        *,
        ...
        def __init__(
            self,
            children: __dataclass__init__fields__0__annotation,
        ) -> __dataclass__None:
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('service_cls', 'spec', 'ctor', 'configs', 'children')), EqPlan(fields=('service_cl"
        "s', 'spec', 'ctor', 'configs', 'children')), FrozenPlan(fields=('service_cls', 'spec', 'ctor', 'configs', 'chi"
        "ldren'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('service_cls', 'spec', 'ctor', 'con"
        "figs', 'children'), cache=False), InitPlan(fields=(InitPlan.Field(name='service_cls', annotation=OpRef(name='i"
        "nit.fields.0.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType"
        ".INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='spec', annotation=OpRef(name='in"
        "it.fields.1.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType."
        "INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='ctor', annotation=OpRef(name='ini"
        "t.fields.2.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.I"
        "NSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='configs', annotation=OpRef(name='i"
    ...
    def _process_dataclass(
        *,
        ...
        def __init__(
            self,
            service_cls: __dataclass__init__fields__0__annotation,
            spec: __dataclass__init__fields__1__annotation,
            ctor: __dataclass__init__fields__2__annotation,
            configs: __dataclass__init__fields__3__annotation = __dataclass__init__fields__3__default,
            children: __dataclass__init__fields__4__annotation = __dataclass__init__fields__4__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'service_cls', service_cls)
            __dataclass__object_setattr(self, 'spec', spec)
        ...
        def __repr__(self):
            parts = []
            if (s := __dataclass__repr__default_fn(self.service_cls)) is not None:
                parts.append(f"service_cls={s}")
            if (s := __dataclass__repr__default_fn(self.spec)) is not None:
                parts.append(f"spec={s}")
            if (s := __dataclass__repr__default_fn(self.ctor)) is not None:
                parts.append(f"ctor={s}")
            if (s := __dataclass__repr__default_fn(self.configs)) is not None:
                parts.append(f"configs={s}")
            if (s := __dataclass__repr__default_fn(self.children)) is not None:
                parts.append(f"children={s}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.minichain.tools.types', 'ToolSpec'),
    ),
)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('id', 'name', 'args', 'raw_args', '_metadata')), EqPlan(fields=('id', 'name', 'arg"
        "s', 'raw_args', '_metadata')), FrozenPlan(fields=('id', 'name', 'args', 'raw_args', '_metadata'), allow_dynami"
        "c_dunder_attrs=False), HashPlan(action='add', fields=('id', 'name', 'args', 'raw_args', '_metadata'), cache=Fa"
        "lse), InitPlan(fields=(InitPlan.Field(name='id', annotation=OpRef(name='init.fields.0.annotation'), default=Op"
        "Ref(name='init.fields.0.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTA"
        "NCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='name', annotation=OpRef(name='init.fie"
        "lds.1.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTAN"
        "CE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='args', annotation=OpRef(name='init.fiel"
        "ds.2.annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANC"
        "E, coerce=None, validate=None, check_type=None), InitPlan.Field(name='raw_args', annotation=OpRef(name='init.f"
        "ields.3.annotation'), default=OpRef(name='init.fields.3.default'), default_factory=None, init=True, override=F"
        "alse, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='_metad"
        "ata', annotation=OpRef(name='init.fields.4.annotation'), default=OpRef(name='init.fields.4.default'), default_"
        "factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=OpRef(name='init.fields.4.coerc"
        "e'), validate=None, check_type=None)), self_param='self', std_params=(), kw_only_params=('id', 'name', 'args',"
        " 'raw_args', '_metadata'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), Rep"
        "rPlan(fields=(ReprPlan.Field(name='id', kw_only=True, fn=None), ReprPlan.Field(name='name', kw_only=True, fn=N"
        "one), ReprPlan.Field(name='args', kw_only=True, fn=None), ReprPlan.Field(name='raw_args', kw_only=True, fn=Non"
...
def _process_dataclass__8ee14eb5eb676d4070b1ed3fcffc299ec6ef79b1():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            ...
            raw_args: __dataclass__init__fields__3__annotation = __dataclass__init__fields__3__default,
            _metadata: __dataclass__init__fields__4__annotation = __dataclass__init__fields__4__default,
        ) -> __dataclass__None:
            _metadata = __dataclass__init__fields__4__coerce(_metadata)
            __dataclass__object_setattr(self, 'id', id)
            __dataclass__object_setattr(self, 'name', name)
            __dataclass__object_setattr(self, 'args', args)
            __dataclass__object_setattr(self, 'raw_args', raw_args)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('id', 'name', 'c', '_metadata')), EqPlan(fields=('id', 'name', 'c', '_metadata')),"
        " FrozenPlan(fields=('id', 'name', 'c', '_metadata'), allow_dynamic_dunder_attrs=False), HashPlan(action='add',"
        " fields=('id', 'name', 'c', '_metadata'), cache=False), InitPlan(fields=(InitPlan.Field(name='id', annotation="
        ...
        "Field(name='name', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, init"
        "=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.F"
        "ield(name='c', annotation=OpRef(name='init.fields.2.annotation'), default=None, default_factory=None, init=Tru"
        "e, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field"
        "(name='_metadata', annotation=OpRef(name='init.fields.3.annotation'), default=OpRef(name='init.fields.3.defaul"
        "t'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=OpRef(name='init.f"
        "ields.3.coerce'), validate=None, check_type=None)), self_param='self', std_params=(), kw_only_params=('id', 'n"
        "ame', 'c', '_metadata'), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), ReprP"
...
def _process_dataclass__a4d08164172a00809d5421a80bd0c9f803d609cf():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            ...
            *,
            ...
            _metadata: __dataclass__init__fields__3__annotation = __dataclass__init__fields__3__default,
        ) -> __dataclass__None:
            _metadata = __dataclass__init__fields__3__coerce(_metadata)
            __dataclass__object_setattr(self, 'id', id)
            __dataclass__object_setattr(self, 'name', name)
            __dataclass__object_setattr(self, 'c', c)
            __dataclass__object_setattr(self, '_metadata', _metadata)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('ts',)), EqPlan(fields=('ts',)), FrozenPlan(fields=('ts',), allow_dynamic_dunder_a"
        "ttrs=False), HashPlan(action='add', fields=('ts',), cache=False), InitPlan(fields=(InitPlan.Field(name='ts', a"
        "nnotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=True, override=Fals"
        "e, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None),), self_param='self', std_param"
        "s=('ts',), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), "
        "ReprPlan(fields=(ReprPlan.Field(name='ts', kw_only=False, fn=None),), id=False, terse=False, default_fn=None))"
        ")"
    ),
...
def _process_dataclass__7aa0c77816a80679651208a64d723952e216d065():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            ts: __dataclass__init__fields__0__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'ts', ts)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('ty', 't')), EqPlan(fields=('ty', 't')), FrozenPlan(fields=('ty', 't'), allow_dyna"
        "mic_dunder_attrs=False), HashPlan(action='add', fields=('ty', 't'), cache=False), InitPlan(fields=(InitPlan.Fi"
        "eld(name='ty', annotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=Tru"
        "e, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field"
        "(name='t', annotation=OpRef(name='init.fields.1.annotation'), default=None, default_factory=None, init=True, o"
        "verride=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None)), self_param='self'"
        ", std_params=('ty', 't'), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), val"
        "idate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='ty', kw_only=False, fn=None), ReprPlan.Field(name='t', kw"
        "_only=False, fn=None)), id=False, terse=False, default_fn=None)))"
    ),
...
def _process_dataclass__df51b7d1de0f9f842f3c7c328814272743a295d9():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('gt',)), EqPlan(fields=('gt',)), FrozenPlan(fields=('gt',), allow_dynamic_dunder_a"
        "ttrs=False), HashPlan(action='add', fields=('gt',), cache=False), InitPlan(fields=(InitPlan.Field(name='gt', a"
        "nnotation=OpRef(name='init.fields.0.annotation'), default=None, default_factory=None, init=True, override=Fals"
        "e, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None),), self_param='self', std_param"
        "s=('gt',), kw_only_params=(), frozen=True, slots=False, post_init_params=None, init_fns=(), validate_fns=()), "
        "ReprPlan(fields=(ReprPlan.Field(name='gt', kw_only=False, fn=None),), id=False, terse=False, default_fn=None))"
        ")"
    ),
...
def _process_dataclass__6b438fb80b632e7c116149b68543db28b834e32e():
    def _process_dataclass(
        *,
        __class__,
        __dataclass__init__fields__0__annotation,
        ...
        def __init__(
            self,
            gt: __dataclass__init__fields__0__annotation,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'gt', gt)
...
@_register(
    plan_repr=(
        ...
        ", field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='retry_serv"
        "ice', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init.fields.1.default'), default_"
        "factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type"
        "=None)), self_param='self', std_params=('num_retries',), kw_only_params=('retry_service',), frozen=True, slots"
        "=False, post_init_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='num_retrie"
        "s', kw_only=False, fn=None), ReprPlan.Field(name='retry_service', kw_only=True, fn=None)), id=False, terse=Fal"
        "se, default_fn=None)))"
    ),
        ...
        *,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.num_retries == other.num_retries and
                self.retry_service == other.retry_service
            )
        ...
        def __init__(
            self,
            num_retries: __dataclass__init__fields__0__annotation,
            *,
            retry_service: __dataclass__init__fields__1__annotation = __dataclass__init__fields__1__default,
        ) -> __dataclass__None:

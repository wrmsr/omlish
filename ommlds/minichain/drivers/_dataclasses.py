...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('uuid', 'next_user_chat', 'ai_message_uuid')), EqPlan(fields=('uuid', 'next_user_c"
        "hat', 'ai_message_uuid')), FrozenPlan(fields=('uuid', 'next_user_chat', 'ai_message_uuid'), allow_dynamic_dund"
        "er_attrs=False), HashPlan(action='add', fields=('uuid', 'next_user_chat', 'ai_message_uuid'), cache=False), In"
        "itPlan(fields=(InitPlan.Field(name='uuid', annotation=OpRef(name='init.fields.0.annotation'), default=None, de"
        "fault_factory=OpRef(name='init.fields.0.default_factory'), init=True, override=False, field_type=FieldType.INS"
        ...
        *,
        ...
        def __copy__(self):
            ...
            return __dataclass__cls(  # noqa
                ...
                ai_message_uuid=self.ai_message_uuid,
            )
        ...
        def __eq__(self, other):
            ...
            return (
                ...
                self.next_user_chat == other.next_user_chat and
                self.ai_message_uuid == other.ai_message_uuid
            )
        ...
        def __repr__(self):
            ...
            parts.append(f"ai_message_uuid={self.ai_message_uuid!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('chat', 'message_uuid')), EqPlan(fields=('chat', 'message_uuid')), FrozenPlan(fiel"
        "ds=('chat', 'message_uuid'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('chat', 'messag"
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('enable_write_tools',)), EqPlan(fields=('enable_write_tools',)), FrozenPlan(fields"
        "=('enable_write_tools',), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('enable_write_tool"
        "s',), cache=False), InitPlan(fields=(InitPlan.Field(name='enable_write_tools', annotation=OpRef(name='init.fie"
        "lds.0.annotation'), default=OpRef(name='init.fields.0.default'), default_factory=None, init=True, override=Fal"
        "se, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None),), self_param='self', std_para"
        "ms=(), kw_only_params=('enable_write_tools',), frozen=True, slots=False, post_init_params=None, init_fns=(), v"
        "alidate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='enable_write_tools', kw_only=True, fn=None),), id=False"
        ", terse=False, default_fn=None)))"
    ),
    plan_repr_sha1='ed0b578dcf9822091ce2bb9e24565a80ef51620d',
    op_ref_idents=(
        '__dataclass__init__fields__0__annotation',
        '__dataclass__init__fields__0__default',
    ),
...
def _process_dataclass__ed0b578dcf9822091ce2bb9e24565a80ef51620d():
    def _process_dataclass(
        *,
        __dataclass__cls,
        __dataclass__init__fields__0__annotation,
        ...
        def __eq__(self, other):
            ...
            if self.__class__ is not other.__class__:
                return NotImplemented
            return (
                self.enable_write_tools == other.enable_write_tools
            )
        ...
        def __init__(
            self,
            *,
            enable_write_tools: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
        ) -> __dataclass__None:
            __dataclass__object_setattr(self, 'enable_write_tools', enable_write_tools)
        ...
        def __repr__(self):
            parts = []
            parts.append(f"enable_write_tools={self.enable_write_tools!r}")
            return (
                f"{self.__class__.__qualname__}("
                f"{', '.join(parts)}"
                f")"

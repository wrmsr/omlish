...
#     tva = check.single(tve.args)
#
#     if isinstance(tva, rfl.Instance):
#         raise NotImplementedError
#
#     elif isinstance(tva, rfl.AnyType):
#         tvp = check.single(tve.info.type_vars)
#         raise NotImplementedError
#
#     else:
#         raise TypeError(rty)

...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.cli.sessions.chat.agents.configs', 'StateConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.cli.sessions.chat.agents.configs', 'ToolSetConfig'),
...
@_register(
    ...
    cls_names=(
        ...
        ('ommlds.cli.sessions.chat.agents.configs', 'ToolsConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.sessions.chat.agents.agent', 'AiMessagesChatAgentOutput'),
        ('ommlds.cli.sessions.chat.agents.agent', 'UserMessagesChatAgentInput'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.sessions.chat.agents.configs', 'AiConfig'),
    ),
)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('ai', 'backend', 'state', 'tools')), EqPlan(fields=('ai', 'backend', 'state', 'too"
        "ls')), FrozenPlan(fields=('ai', 'backend', 'state', 'tools'), allow_dynamic_dunder_attrs=False), HashPlan(acti"
        "on='add', fields=('ai', 'backend', 'state', 'tools'), cache=False), InitPlan(fields=(InitPlan.Field(name='ai',"
        ...
        "), InitPlan.Field(name='backend', annotation=OpRef(name='init.fields.1.annotation'), default=OpRef(name='init."
        "fields.1.default'), default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=Non"
        "e, validate=None, check_type=None), InitPlan.Field(name='state', annotation=OpRef(name='init.fields.2.annotati"
        "on'), default=OpRef(name='init.fields.2.default'), default_factory=None, init=True, override=False, field_type"
        "=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='tools', annotation=OpR"
        ...
        "'self', std_params=(), kw_only_params=('ai', 'backend', 'state', 'tools'), frozen=True, slots=False, post_init"
        "_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='ai', kw_only=True, fn=None)"
        ", ReprPlan.Field(name='backend', kw_only=True, fn=None), ReprPlan.Field(name='state', kw_only=True, fn=None), "
        "ReprPlan.Field(name='tools', kw_only=True, fn=None)), id=False, terse=False, default_fn=None)))"
    ),
    plan_repr_sha1='5d3a6ba2a004b8ae7d11b39f45c09d9528575169',
    op_ref_idents=(
        '__dataclass__init__fields__0__annotation',
        '__dataclass__init__fields__0__default',
        '__dataclass__init__fields__1__annotation',
    ...
    cls_names=(
        ('ommlds.cli.sessions.chat.agents.configs', 'DriverConfig'),
    ),
)
def _process_dataclass__5d3a6ba2a004b8ae7d11b39f45c09d9528575169():
    def _process_dataclass(
        *,
        __dataclass__cls,
        __dataclass__init__fields__0__annotation,

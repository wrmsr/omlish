...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.drivers.state.inject', 'LastChatId'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'InputTextArea.HistoryNext'),
        ('ommlds.cli.chat.interfaces.textual.app', 'InputTextArea.HistoryPrevious'),
        ('ommlds.cli.chat.interfaces.textual.app', 'InputTextArea.Submitted'),
    ),
)
...
@_register(
    ...
    op_ref_idents=(),
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'InputTextArea.HistoryReset'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'MessageDividerClicked'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'MessageFinalized'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'SuggestionItem'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.chat.interfaces.textual.app', 'SuggestionsManager.Config'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.inject', 'BackendConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.inject', 'CompletionConfig'),
        ('ommlds.cli.inject', 'EmbeddingConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.inject', 'InterfaceConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.inject', 'PrintingConfig'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.main', 'WebInterfaceConfig'),
    ),
)

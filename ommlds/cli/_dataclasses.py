...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.drivers.state.inject', 'LastChatId'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'ChatApp.UserInput'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'ContentStreamAiMessagePart'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'FinalStreamAiMessagePart'),
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'StreamAiMessagePart'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'InputTextArea.HistoryNext'),
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'InputTextArea.HistoryPrevious'),
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'InputTextArea.Submitted'),
    ),
)
...
@_register(
    ...
    op_ref_idents=(),
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'InputTextArea.HistoryReset'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'MessageFinalized'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'SuggestionItem'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.entrypoints.chat.interfaces.textual.app', 'SuggestionsManager.Config'),
    ),
)
...
@_register(
    ...
    cls_names=(
        ('ommlds.cli.inject', 'EntrypointConfig'),
    ),
)

...
class RotaryEmbedding(Module):
    def __init__(
            self,
            dim,
            custom_freqs: ta.Optional[Tensor] = None,
            freqs_for: ta.Union[
                ta.Literal['lang'],
                ta.Literal['pixel'],
                ta.Literal['constant']
    ...
    def rotate_queries_or_keys(self, t, seq_dim=None, offset=0, freq_seq_len=None):
        ...
        assert (
            not self.use_xpos,
            'you must use `.rotate_queries_and_keys` method instead and pass in both queries and keys, for length '
            'extrapolatable rotary embeddings'
        )

...
def test_inspect_runtime_members_classifies_descriptor_kinds() -> None:
    ...
    inspection = mr.inspect_runtime_members(Example)
...
def test_inspect_runtime_members_exposes_unbound_signatures() -> None:
    ...
    mr = make_members_reflector()
    members = mr.inspect_runtime_members(Example).members_by_name
...
def test_inspect_runtime_members_preserves_literal_new_type_method_signature_shape() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Example).members_by_name['set_mode']
    signature = member.reflected_signature
    call_signature = mr.get_member_call_signature(member)
...
def test_inspect_runtime_members_preserves_parameter_kinds_and_defaults() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Example).members_by_name['method']
    signature = member.reflected_signature
...
def test_inspect_runtime_members_uses_any_for_omitted_annotations() -> None:
    ...
    mr = make_members_reflector()
    reflected_signature = mr.inspect_runtime_members(Example).members_by_name['method'].reflected_signature
...
def test_get_member_call_signature_drops_cls_for_classmethod() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Example).members_by_name['create']
    call_signature = mr.get_member_call_signature(member)
...
def test_get_member_value_type_exposes_property_return_type() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Example).members_by_name['value']
    value_type = mr.get_member_value_type(member)

    assert value_type is not None
    assert type_str(value_type) == 'builtins.int'
    assert mr.get_member_call_signature(member) is None
...
def test_callable_data_member_has_no_member_call_signature() -> None:
    ...
    assert mr.get_member_call_signature(members['callback']) is not None
    assert members['callable_value'].kind == RuntimeMemberKind.DATA
    assert mr.get_member_call_signature(members['callable_value']) is None
...
def test_inspect_runtime_members_uses_subclass_owner_for_overrides() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Child).members_by_name['method']
...
def test_inspect_runtime_members_accepts_parameterized_alias_origin() -> None:
    ...
    mr = make_members_reflector()
    inspection = mr.inspect_runtime_members(Box[int])
...
def test_inspect_runtime_members_replaces_parameterized_alias_method_return() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Box[int]).members_by_name['get']
    call_signature = mr.get_member_call_signature(member)
...
def test_inspect_runtime_members_replaces_parameterized_alias_method_parameter() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Box[int]).members_by_name['put']
    call_signature = mr.get_member_call_signature(member)
...
def test_inspect_runtime_members_uses_any_for_unparameterized_generic_method() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Box).members_by_name['get']
    call_signature = mr.get_member_call_signature(member)
...
def test_inspect_runtime_members_replaces_inherited_generic_method() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(StrBox).members_by_name['get']
    call_signature = mr.get_member_call_signature(member)
...
def test_member_order_is_base_then_subclass_with_overrides_in_place() -> None:
    ...
    mr = make_members_reflector()
    inspection = mr.inspect_runtime_members(Child)
...
def test_inspect_runtime_members_collects_typing_overloads() -> None:
    ...
    mr = make_members_reflector()
    member = mr.inspect_runtime_members(Example).members_by_name['method']
    signatures = mr.get_member_call_signatures(member)
...
def test_overloaded_member_call_signature_keys_preserve_overload_order() -> None:
    ...
    mr = make_members_reflector()
    left_signatures = mr.get_member_call_signatures(mr.inspect_runtime_members(Left).members_by_name['method'])
    right_signatures = mr.get_member_call_signatures(mr.inspect_runtime_members(Right).members_by_name['method'])

...
from ..features.search import OptOps
...
def helper_add_store(op):
    ...
    return LazyOp(
        BufferOps.STORE,
        (op,),
        MemBuffer(0, info.dtype, ShapeTracker.from_shape(info.shape)),
    )
...
class TestLinearizerFailures(unittest.TestCase):
                    ...
                    arg=MemBuffer(
                        ...
                        st=ShapeTracker(
                            views=(
                                View(
                                    shape=(32, 2, 111, 27),
                                    strides=(6160, 3080, 28, 1),
                                    offset=0,
                                    mask=((0, 32), (0, 2), (0, 110), (0, 27)),
                                    contiguous=False,
                                ),
                                View(
                                    shape=(32, 2, 37, 9, 2, 2),
                                    strides=(5994, 2997, 81, 3, 27, 1),
                                    offset=0,
                                    mask=None,
                                    contiguous=False,
                                ),
    ...
    @unittest.skipIf(
        CI and Device.DEFAULT == "METAL", "behaves differently on METAL CI"
    )
    def test_failure_3(self):
        ...
        opts = [
            ...
            Opt(op=OptOps.UNROLL, axis=1, amt=0),
            Opt(op=OptOps.UPCAST, axis=0, amt=4),
            Opt(op=OptOps.LOCAL, axis=0, amt=2),
            Opt(op=OptOps.LOCAL, axis=0, amt=2),
            Opt(op=OptOps.UPCAST, axis=1, amt=0),
        ...
        ast = helper_add_store(ast)
        helper_test_lin(
            Linearizer(ast), opts, failed_platforms=["METAL", "GPU", "CUDA"]
        )
    ...
    def test_failure_4(self):
        ast = LazyOp(
                ...
                LazyOp(
                    ...
                    arg=MemBuffer(
                        ...
                        st=ShapeTracker(
                            views=(
                                View(
                                    shape=(1, 1, 1, 4, 1, 12, 2, 29),
                                    strides=(0, 0, 0, 2, 0, 216, 1, 8),
                                    offset=0,
                                    mask=(
                                        (0, 1),
                                        (0, 1),
                                ...
                                View(
                                    shape=(1, 1, 1, 4, 2, 11, 3, 28),
                                    strides=(0, 0, 0, 1848, 924, 84, 28, 1),
                                    offset=0,
                                    mask=None,
                                    contiguous=True,
                                ),
            ...
            arg=(1, 1, 1, 4, 1, 11, 1, 28),
        )
        opts = [
            Opt(op=OptOps.LOCAL, axis=2, amt=4),
            Opt(op=OptOps.UPCAST, axis=0, amt=2),
            Opt(op=OptOps.UPCAST, axis=0, amt=0),
            Opt(op=OptOps.LOCAL, axis=2, amt=2),
            Opt(op=OptOps.UPCAST, axis=3, amt=0),
            Opt(op=OptOps.UPCAST, axis=2, amt=0),
            Opt(op=OptOps.UNROLL, axis=0, amt=0),
            Opt(op=OptOps.UPCAST, axis=1, amt=0),
            Opt(op=OptOps.NOLOCALS, axis=None, amt=None),
        ]
                ...
                LazyOp(
                    ...
                    arg=MemBuffer(
                        ...
                        st=ShapeTracker(
                            views=(
                                View(
                                    shape=(512, 32, 6, 8, 4, 6, 8, 4),
                                    strides=(2048, 64, 6291456, 8, 0, 1048576, 1, 0),
                                    offset=0,
                                    mask=(
                                        (0, 512),
                                        (0, 32),
                                ...
                                View(
                                    shape=(512, 32, 6, 35, 6, 35),
                                    strides=(1179648, 36864, 6144, 192, 32, 1),
                                    offset=0,
                                    mask=(
                                        (0, 512),
                                        (0, 32),
                                ...
                                View(
                                    shape=(512, 32, 238, 238),
                                    strides=(1411200, 44100, 210, 1),
                                    offset=0,
                                    mask=((0, 512), (0, 32), (0, 210), (0, 210)),
                                    contiguous=False,
                                ),
                                View(
                                    shape=(512, 32, 7, 34, 7, 34),
                                    strides=(1812608, 56644, 8092, 238, 34, 1),
                                    offset=0,
                                    mask=None,
                                    contiguous=True,
                                ),
    ...
    @unittest.skipIf(
        (Device.DEFAULT == "LLVM" and not OSX) or (Device.DEFAULT == "GPU" and CI),
        "Segmentation fault on ubuntu, GPU requires cl_khr_fp16",
    )
    def test_failure_8(self):
        ...
        ast = helper_add_store(ast)
        helper_test_lin(
            Linearizer(ast), opts, failed_platforms=["CLANG", "METAL", "WEBGPU"]
        )
    ...
    def test_failure_9(self):
        ast = LazyOp(
            ...
            src=(
                LazyOp(
                    ...
                    arg=(1, 1, 1, 3, 1, 1, 1, 1, 5, 15, 5, 3, 4),
                ),
            ),
            arg=MemBuffer(
                idx=0,
                ...
                st=ShapeTracker(
                    views=(
                        View(
                            shape=(1, 1, 1, 3, 1, 1, 1, 1, 5, 15, 5, 3, 4),
                            strides=(0, 0, 0, 4500, 0, 0, 0, 0, 900, 60, 12, 4, 1),
                            offset=0,
                            mask=None,
                            contiguous=True,
                        ),
        ...
        # Entry point r_2272_2_2_3 at Compute is invalid
        # Expression [36] is invalid

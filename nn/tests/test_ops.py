...
class TestOps(unittest.TestCase):
    ...
    @unittest.skipIf(
        Device.DEFAULT in ["METAL", "WEBGPU"],
        "WEBGPU does not have support for inf/nan, METAL has issues with -inf",
    )
    ...
    @unittest.skipIf(
        ...
        "this test uses more than 8 bufs passing the WEBGPU limit",

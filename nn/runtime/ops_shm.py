...
#
#         if self.cache_id is not None and self.cache_id in SHM_CACHE:
#             shm = SHM_CACHE[self.cache_id]
#         else:
#             if OSX:
...
#
# # TODO: is this wrong?
# shm_fxn_for_op: Dict[Op, Callable] = {BufferOps.MEM: lambda x: x, UnaryOps.NOOP: lambda x: x,
#                                       MovementOps.RESHAPE: lambda x, _: x, MovementOps.AS_STRIDED: lambda x, _: x}

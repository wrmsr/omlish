...
def _process_dataclass__35f016ce203e8213abc42b9333cca4a0902d0a62():
    def _process_dataclass(
        *,
        ...
        setattr(__class__, '__hash__', None)
...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('tup',)), EqPlan(fields=('tup',)), HashPlan(action='set_none', fields=None, cache="
        "None), InitPlan(fields=(InitPlan.Field(name='tup', annotation=OpRef(name='init.fields.0.annotation'), default="
        "OpRef(name='init.fields.0.default'), default_factory=None, init=True, override=False, field_type=FieldType.INS"
        "TANCE, coerce=None, validate=None, check_type=None),), self_param='self', std_params=('tup',), kw_only_params="
...
def _process_dataclass__e396848ab857a16f8651f7b98bb94eef27cb593f():
    def _process_dataclass(
        *,
        ...
        def __init__(
            self,
            tup: __dataclass__init__fields__0__annotation = __dataclass__init__fields__0__default,
        ) -> __dataclass__None:
            self.tup = tup
...
@_register(
    plan_repr=(
        ...
        "lt_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, coerce=None, validate=None, check_t"
        "ype=None),), self_param='self', std_params=('mode',), kw_only_params=(), frozen=True, slots=False, post_init_p"
        "arams=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='mode', kw_only=False, fn=None"
        "),), id=False, terse=False, default_fn=None)))"
    ),

...
@_register(
    plan_repr=(
        "Plans(tup=(CopyPlan(fields=('m', 'where', 'order_by')), EqPlan(fields=('m', 'where', 'order_by')), FrozenPlan("
        "fields=('m', 'where', 'order_by'), allow_dynamic_dunder_attrs=False), HashPlan(action='add', fields=('m', 'whe"
        "re', 'order_by'), cache=False), InitPlan(fields=(InitPlan.Field(name='m', annotation=OpRef(name='init.fields.0"
        ".annotation'), default=None, default_factory=None, init=True, override=False, field_type=FieldType.INSTANCE, c"
        "oerce=None, validate=None, check_type=None), InitPlan.Field(name='where', annotation=OpRef(name='init.fields.1"
        ".annotation'), default=OpRef(name='init.fields.1.default'), default_factory=None, init=True, override=False, f"
        "ield_type=FieldType.INSTANCE, coerce=None, validate=None, check_type=None), InitPlan.Field(name='order_by', an"
        ...
        " self_param='self', std_params=('m', 'where'), kw_only_params=('order_by',), frozen=True, slots=False, post_in"
        "it_params=None, init_fns=(), validate_fns=()), ReprPlan(fields=(ReprPlan.Field(name='m', kw_only=False, fn=Non"
        "e), ReprPlan.Field(name='where', kw_only=False, fn=None), ReprPlan.Field(name='order_by', kw_only=True, fn=Non"
        "e)), id=False, terse=False, default_fn=None)))"
    ),
    plan_repr_sha1='c89d5612c3756b077fa151157f9598bf9fa44194',
    op_ref_idents=(
        '__dataclass__init__fields__0__annotation',
        '__dataclass__init__fields__1__annotation',
...
def _process_dataclass__c89d5612c3756b077fa151157f9598bf9fa44194():
    def _process_dataclass(
        *,
        __dataclass__cls,
        __dataclass__init__fields__0__annotation,

class Pipeline:
    ...
    def __init__(self, convert_token=None):
        ...
        Arguments:
            convert_token: The function to apply to input sequence data. If None, the identity function is used.
                Default: None
        """
    ...
    def __call__(self, x, *args):
        ...
        Arguments:
            ...
            Positional arguments: Forwarded to the `call` function of the Pipeline(s).
        """
    ...
    def call(self, x, *args):
        """
        Apply _only_ the convert_token function of the current pipeline to the input. If the input is a list, a list
        with the results of applying the `convert_token` function to all input elements is returned.

        Arguments:
            x: The input to apply the convert_token function to.
            Positional arguments: Forwarded to the `convert_token` function of the current Pipeline.
        """

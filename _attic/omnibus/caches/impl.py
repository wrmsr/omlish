...
class CacheImpl(Cache[K, V]):
    ...
    def __init__(
            ...
            *,
            ...
            max_weight: ta.Optional[float] = None,
            identity_keys: bool = False,
            expire_after_access: ta.Optional[float] = None,
            expire_after_write: ta.Optional[float] = None,
            removal_listener: ta.Callable[[ta.Union[K, weakref.ref], ta.Union[V, weakref.ref]], None] = None,
            clock: ta.Optional[ta.Callable[[], float]] = None,
            ...
            track_frequency: ta.Optional[bool] = None,
    ) -> None:
        super().__init__()
        ...
        weak_dead: ta.Optional[ta.Deque[Link]]

...
from onnx.onnx_pb import AttributeProto  # noqa
from onnx.onnx_pb import ModelProto  # noqa
from onnx.onnx_pb import TensorProto  # noqa
from onnx.onnx_pb import TypeProto  # noqa
import numpy as np
...
onnx_ops = lang.proxy_import(__package__ + '.ops')
    ...
    def type_parse(type_proto: TypeProto):
        ...
        while True:
            ...
            if attr == 'tensor_type':
                ...
                raise NotImplementedError(f"sparse_tensor_type is not implemented: {type_proto}")

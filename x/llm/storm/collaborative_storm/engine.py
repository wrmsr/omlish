...
from ..lm import TogetherClient
from ..logging_wrapper import LoggingWrapper
from ..rm import BingSearch
from .modules.callback import BaseCallbackHandler
from .modules.co_storm_agents import CoStormExpert
from .modules.co_storm_agents import Moderator
from .modules.co_storm_agents import PureRAGAgent
from .modules.co_storm_agents import SimulatedUser
...
class CollaborativeStormLMConfigs(LMConfigs):
    ...
    def set_question_answering_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
        self.question_answering_lm = model

    def set_discourse_manage_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
        self.discourse_manage_lm = model

    def set_utterance_polishing_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
        self.utterance_polishing_lm = model

    def set_warmstart_outline_gen_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
        self.warmstart_outline_gen_lm = model

    def set_question_asking_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
        self.question_asking_lm = model

    def set_knowledge_base_lm(self, model: dspy.dsp.LM | dspy.dsp.HFModel):
...
class DiscourseManager:
    ...
    def _parse_expert_names_to_agent(self, expert_descriptions: str | list[str]):

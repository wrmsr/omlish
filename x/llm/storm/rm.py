    ...
    def forward(
        ...
        for query in queries:
            try:
                ...
                logging.exception(f'Error occurs when searching query {query}: {e}')
    ...
    def forward(
        ...
        for query in queries:
            try:
                ...
                logging.exception(f'Error occurred while searching query {query}: {e}')

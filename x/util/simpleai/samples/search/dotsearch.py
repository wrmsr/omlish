...
class DotGraphSearchProblem(SearchProblem):
    ...
    def __init__(self, filename):
        ...
        xs = [(nodo, nodo.attr.get('initial', None)) for nodo in self.G.iternodes()]
...
def report(infile=None, algorithms=None, outfile='report.html', with_images=True):

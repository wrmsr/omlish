...
class TestDump(TestCase):
    ...
    def test_bytes_toplevel(self):
        ...
        self.assertEqual(json.dumps(b('\xa4'), encoding='iso-8859-1'), r'"\u00a4"')
        self.assertEqual(json.dumps(b('\xa4'), encoding='iso-8859-15'), r'"\u20ac"')
        self.assertRaises(TypeError, json.dumps, b('\xe2\x82\xac'), encoding=None)

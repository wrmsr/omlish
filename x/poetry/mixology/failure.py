...
class _Writer:
    ...
    def _visit(
        ...
        cause = check.isinstance(incompatibility.cause, ConflictCauseError)

        if (
                isinstance(cause.conflict.cause, ConflictCauseError) and
                isinstance(cause.other.cause, ConflictCauseError)
        ):
            ...
            if conflict_line is not None and other_line is not None:
                ...
                isinstance(cause.conflict.cause, ConflictCauseError) or
                isinstance(cause.other.cause, ConflictCauseError)
        ):
            derived = (
                cause.conflict
            ...
            if derived_line is not None:
                ...
                derived_cause = check.isinstance(derived.cause, ConflictCauseError)
    ...
    def _is_collapsible(self, incompatibility: 'Incompatibility') -> bool:
        ...
        if (
                not isinstance(cause.conflict.cause, ConflictCauseError) and
                not isinstance(cause.other.cause, ConflictCauseError)
        ):
            return False

...
class Term:
    ...
    def satisfies(self, other: 'Term') -> bool:
        ...
        return (
            self.dependency.complete_name == other.dependency.complete_name and
    ...
    def _intersect(self, other: 'Term') -> ta.Optional['Term']:
    ...
    def difference(self, other: 'Term') -> ta.Optional['Term']:
        """Returns a Term that represents packages allowed by this term and not by the other."""

        return self.intersect(other.inverse)

    def _compatible_dependency(self, other: Dependency) -> bool:
        return (
            self.dependency.is_root or
            other.is_root or
            other.is_same_package_as(self.dependency) or
            (
                # we do this here to indicate direct origin dependencies are compatible with NVR dependencies

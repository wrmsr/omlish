...
from prompt_toolkit.key_binding.bindings.vi import create_text_object_decorator
...
def main():
    ...
    bindings = ptk.KeyBindings()

    # Create the decorators to be used for registering text objects and operators in this registry.
    ...
    text = ptk.prompt(
        ...
        editing_mode=ptk.EditingMode.VI,
    )

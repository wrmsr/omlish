...
class Rule(_Rule):
    ...
    # The grammar in this RFC follows the rules as defined in RFC 2616, not RFC 5234. In particular, it uses | instead
    # of / for alternation, and white space here and there is implicit in RFC 2616. The grammar below is updated to
    # follow RFC 5234.

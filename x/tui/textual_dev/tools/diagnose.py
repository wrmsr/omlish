...
def _guess_term() -> str:
    ...
    if term_program is None:
        # Seems we couldn't get it that way. Let's check for some of the more common terminal signatures.
        ...
        elif os.environ.get('INSIDE_EMACS'):
            term_program = (
    ...
    # Check for running under screen. As you look at this you might think "what about tmux too?" -- good point; but
    # we'll be picking up tmux as the terminal type, because of how it takes over TERM_PROGRAM.
...
def _str_rich(value: ta.Any) -> str:
    """
...
def diagnose() -> None:
    ...
    # recommendations to the user (eg: don't use Windows console, use Windows Terminal; don't use macOS Terminal.app,
    # etc).

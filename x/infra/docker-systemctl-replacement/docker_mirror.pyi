...
def output3(
    cmd: Union[str, List[str]], shell: bool = True, debug: bool = True
) -> Tuple[str, str, int]: ...
...
class DockerMirrorPackagesRepo:
    ...
    def docker_mirror(
        self, rmi: str, rep: str, ver: str, *hosts: str
    ) -> DockerMirror: ...
    ...
    def wait_mirrors(self, hosts: Dict[str, Optional[str]]) -> int:
    ...
    def from_dockerfile(
        self, dockerfile: str, defaults: Optional[str] = None
    ) -> Optional[str]: ...

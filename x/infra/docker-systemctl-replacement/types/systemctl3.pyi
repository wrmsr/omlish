...
from typing import Match, TextIO, Iterator
...
def to_list(
    value: Union[str, List[str], Tuple[str], Tuple[str, ...], None]
) -> List[str]: ...
...
class SystemctlConfData:
    ...
    def __init__(
        ...
        dict_type: Optional[Type[Dict[str, List[str]]]] = ...,
        conf_type: Optional[Type[Dict[str, Dict[str, List[str]]]]] = ...,
        allow_no_value: bool = ...,
    ) -> None: ...
...
class SystemctlSocket:
    def __init__(
        self, conf: SystemctlConf, sock: socket.socket, skip: bool = False
    ) -> None: ...
    def fileno(self) -> int: ...
...
class SystemctlConf:
    ...
    _user_mode: bool
    def __init__(
        self, data: SystemctlConfData, module: Optional[str] = ...
    ) -> None: ...
...
def conf_sortedAfter(
    conflist: Iterable[SystemctlConf],
    cmp: Callable[[SystemctlConf, SystemctlConf], int] = ...,
) -> List[SystemctlConf]:
    class SortTuple:
...
class Systemctl:
    ...
    def load_sysd_template_conf(
        self, module: Optional[str]
    ) -> Optional[SystemctlConf]: ...  # -> conf?
    def load_sysd_unit_conf(
        self, module: Optional[str]
    ) -> Optional[SystemctlConf]:  # -> conf?
        drop_in_files: Dict[str, str]
    ...
    def load_unit_conf(
        self, module: Optional[str]
    ) -> Optional[SystemctlConf]: ...  # -> conf | None(not-found)
    def default_unit_conf(
        self, module: str, description: Optional[str] = None
    ) -> SystemctlConf: ...  # -> conf
    def get_unit_conf(
        self, module: str
    ) -> SystemctlConf: ...  # -> conf (conf | default-conf)
    def get_unit_type(self, module: str) -> Optional[str]: ...
    def get_unit_section(self, module: str, default: str = "Service") -> str: ...
    def get_unit_section_from(
        self, conf: SystemctlConf, default: str = "Service"
    ) -> str: ...
    def match_sysd_templates(
        self, modules: Optional[List[str]] = None, suffix: str = ".service"
    ) -> Iterable[str]: ...  # -> generate[ unit ]
    def match_sysd_units(
        self, modules: Optional[List[str]] = None, suffix: str = ".service"
    ) -> Iterable[str]: ...  # -> generate[ unit ]
    def match_sysv_units(
        self, modules: Optional[List[str]] = None, suffix: str = ".service"
    ) -> Iterable[str]: ...  # -> generate[ unit ]
    def match_units(
        self, modules: Optional[List[str]] = None, suffix: str = ".service"
    ...
    def list_service_units(
        self, *modules: str
    ) -> List[Tuple[str, str, str]]:  # -> [ (unit,loaded+active+substate,description) ]
        result: Dict[str, str]
        active: Dict[str, str]
        substate: Dict[str, str]
        description: Dict[str, str]

    def list_units_modules(self, *modules: str) -> List[
        Tuple[
            str,
            str,
            str,
        ]
    ]: ...  # -> [ (unit,loaded,description) ]
    def list_service_unit_files(
        self, *modules: str
    ) -> List[Tuple[str, str]]:  # -> [ (unit,enabled) ]
        result: Dict[str, Optional[SystemctlConf]]
        enabled: Dict[str, str]

    def each_target_file(self) -> Iterable[Tuple[str, str]]: ...
    def list_target_unit_files(
        self, *modules: str
    ) -> List[Tuple[str, str]]:  # -> [ (unit,enabled) ]
        enabled: Dict[str, str]
        targets: Dict[str, Optional[str]]

    def list_unit_files_modules(
        self, *modules: str
    ) -> List[Tuple[str, str]]:  # -> [ (unit,enabled) ]
        result: List[Tuple[str, str]]

    def get_description(self, unit: str, default: Optional[str] = None) -> str: ...
    def get_description_from(
        self, conf: Optional[SystemctlConf], default: Optional[str] = None
    ) -> str: ...  # -> text
    def read_pid_file(
        self, pid_file: str, default: Optional[int] = None
    ) -> Optional[int]: ...
    def wait_pid_file(
        self, pid_file: str, timeout: Optional[int] = None
    ) -> Optional[int]: ...  # -> pid?
    def get_status_pid_file(self, unit: str) -> str: ...  # -> text
    def pid_file_from(self, conf: SystemctlConf, default: str = "") -> str: ...
    def get_pid_file(
        self, conf: SystemctlConf, default: Optional[str] = None
    ) -> str: ...
    def read_mainpid_from(
        self, conf: SystemctlConf, default: Optional[int] = None
    ) -> Optional[int]: ...
    def clean_pid_file_from(self, conf: SystemctlConf) -> None: ...
    def get_status_file(self, unit: str) -> str: ...  # for testing
    def get_status_file_from(
        self, conf: SystemctlConf, default: Optional[str] = None
    ) -> str: ...
    def get_StatusFile(
        self, conf: SystemctlConf, default: Optional[str] = None
    ...
    def write_status_from(
        self, conf: SystemctlConf, **status: Union[str, int, None]
    ) -> bool: ...  # -> bool(written)
    def read_status_from(self, conf: SystemctlConf) -> Dict[str, str]:
        status: Dict[str, str]

    def get_status_from(
        self, conf: SystemctlConf, name: str, default: Optional[str] = None
    ) -> Optional[str]: ...
    def set_status_from(
        self, conf: SystemctlConf, name: str, value: Optional[str]
    ) -> None: ...
    ...
    def read_env_file(
        self, env_file: str
    ) -> Iterable[Tuple[str, str]]: ...  # -> generate[ (name,value) ]
    def read_env_part(
        self, env_part: str
    ) -> Iterable[Tuple[str, str]]: ...  # -> generate[ (name, value) ]
    ...
    def exec_newcmd(
        self, cmd: str, env: Dict[str, str], conf: SystemctlConf
    ) -> Tuple[ExecMode, List[str]]: ...
    ...
    def remove_service_directories(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> bool:
        env: Dict[str, str]

    def do_rm_tree(self, path: str) -> bool: ...
    def get_RuntimeDirectoryPreserve(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> bool: ...
    def get_RuntimeDirectory(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_StateDirectory(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_CacheDirectory(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_LogsDirectory(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_ConfigurationDirectory(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_RuntimeDirectoryMode(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_StateDirectoryMode(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_CacheDirectoryMode(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_LogsDirectoryMode(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def get_ConfigurationDirectoryMode(
        self, conf: SystemctlConf, section: str = "Service"
    ) -> str: ...
    def clean_service_directories(
        self, conf: SystemctlConf, which: str = ""
    ) -> bool: ...
    ...
    def log_units(
        self, units: List[str], lines: Optional[int] = None, follow: bool = False
    ) -> int: ...
    def log_unit(
        self, unit: str, lines: Optional[int] = None, follow: bool = False
    ) -> int: ...
    def log_unit_from(
        self, conf: SystemctlConf, lines: Optional[int] = None, follow: bool = False
    ) -> int:
    ...
    def get_notify_socket_from(
        self, conf: SystemctlConf, socketfile: Optional[str] = None, debug: bool = False
    ) -> str: ...
    def notify_socket_from(
        self, conf: SystemctlConf, socketfile: Optional[str] = None
    ) -> NotifySocket: ...
    def read_notify_socket(self, notify: NotifySocket, timeout: float) -> str: ...
    def wait_notify_socket(
        self,
        notify: NotifySocket,
        timeout: float,
    ...
    def do_accept_socket_from(
        self, conf: SystemctlConf, sock: socket.socket
    ) -> bool: ...
    ...
    def create_unix_socket(
        self, conf: SystemctlConf, path: str, dgram: bool
    ) -> Optional[socket.socket]: ...
    def create_port_socket(
        self, conf: SystemctlConf, port: str, dgram: bool
    ) -> Optional[socket.socket]: ...
    def create_port_ipv4_socket(
        self, conf: SystemctlConf, addr: str, port: str, dgram: bool
    ) -> Optional[socket.socket]: ...
    def create_port_ipv6_socket(
        self, conf: SystemctlConf, addr: str, port: str, dgram: bool
    ) -> Optional[socket.socket]: ...
    ...
    def dup2_journal_log(self, conf: SystemctlConf) -> None: ...
    def execve_from(
        self, conf: SystemctlConf, cmd: List[str], env: Dict[str, str]
    ) -> NoReturn:
        # cmd_args: Sequence[str]
        cmd_args: List[Union[str, bytes]]
    ...
    def default_enablefolder(
        self, wanted: str, basefolder: Optional[str] = None
    ) -> str: ...
    ...
    def get_dependencies_unit(
        self, unit: str, styles: Optional[List[str]] = None
    ) -> Dict[str, str]:
        deps: Dict[str, str]
    ...
    def get_start_dependencies(
        self, unit: str, styles: Optional[List[str]] = None
    ) -> Dict[str, List[str]]:  # pragma: no cover
        deps: Dict[str, List[str]]

    def list_start_dependencies_modules(
        self, *modules: str
    ) -> List[Tuple[str, str]]: ...
    ...
    def each_unit_items(
        self, unit: str, conf: SystemctlConf
    ...
    def target_default_services(
        self, target: Optional[str] = None, sysv: str = "S"
    ) -> List[str]: ...
    def enabled_target_services(
        self, target: str, sysv: str = "S", igno: List[str] = []
    ) -> List[str]:
        units: List[str]

    def enabled_target_user_local_units(
        self, target: str, unit_kind: str = ".service", igno: List[str] = []
    ) -> List[str]:
        units: List[str]

    def enabled_target_user_system_units(
        self, target: str, unit_kind: str = ".service", igno: List[str] = []
    ) -> List[str]:
        units: List[str]

    def enabled_target_installed_system_units(
        self, target: str, unit_type: str = ".service", igno: List[str] = []
    ) -> List[str]:
        units: List[str]
    ...
    def enabled_target_sysv_units(
        self, target: str, sysv: str = "S", igno: List[str] = []
    ) -> List[str]:
        units: List[str]
        folders: List[str]

    def required_target_units(
        self, target: str, unit_type: str, igno: List[str]
    ) -> List[str]:
        units: List[str]
    ...
    def get_StartLimitIntervalSec(
        self, conf: SystemctlConf, maximum: Optional[int] = None
    ) -> float: ...
    def get_RestartSec(
        self, conf: SystemctlConf, maximum: Optional[int] = None
    ) -> float: ...
    def restart_failed_units(
        self, units: List[str], maximum: Optional[int] = None
    ) -> List[str]:
...
def print_str_list_list(
    result: Union[List[Tuple[str]], List[Tuple[str, str]], List[Tuple[str, str, str]]]
) -> None: ...

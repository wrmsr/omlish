...
class AnyioAsyncliteBase(Abstract):
    ...
    def _translate_exceptions(cls) -> ta.Generator[None, None, None]:
        try:
            ...
            # anyio raises WouldBlock for both send_nowait and receive_nowait
            # We need to translate this to queue.Empty or queue.Full depending on context
            # The caller will need to catch and re-raise the appropriate exception

...
class LocalRule(_Rule):
    """
    Implementations of some RFC 6265 rules defined as prose values. The definition of subdomain is taken from RFC1034
    and RFC1123, with IPv6 support added. The definition of subdomain found therein contained left-recursion; the
    definition here does not. The definitions of path-value, extension-av incorporate verified errata.
    """
